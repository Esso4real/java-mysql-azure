                ...
                <div class="navbar navbar-custom navbar-static-top" role="navigation">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <i class="brand_network"><small><small>IT Training Hub</small></small></i>
                        </div>
                        <div class="navbar-collapse collapse" style="display: flex; justify-content: center; align-items: center;">
...
<div class="w3-content w3-padding" style="max-width:1564px">
  ...
  <div class="container w3-padding-32" id="about">
    ...
    <div class="w3-content" style="max-width:700px">
	    <p style="text-align:justify;">TechMinds Acaddemy is an IT Educational Institute.Established in 2010,and Institute offers world class quality of education and wide range of courses.TecchMinds Academy has a dedicated placement team to help students get job placement in various IT job roles with major companies.
	    </p>
	    <p><strong>Address:</strong>  7622 Dutch Loop, Colorado Springs, CO 80925</p> 
	    <p><strong>Ph No: </strong>  +1 (719) 722-5178</p>
		<p><strong>E-Mail ID :</strong>  info@techminds.com</p>
  	</div>
   </div>
...
<footer class="w3-center  w3-padding-16" style="background-color:#1C3B47 ">
  <p style="color:#FFFFFF ">Copyright @2017 <a href="#"  target="_blank" class="w3-hover-text-green"> techmindsacademy.com</a></p>
</footer>
